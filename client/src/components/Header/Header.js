...
const Header = () => {
  ...
  //changing burger icon to cross icon
  const showMobileNav = () => {
  ...
  return (
    <>
      <header className={classes.header}>
        ...
        <div className={classes.headerControls}>
          <div
            ...
            className={classes.personImg}></div>
          <h2>{`${user.name}`}</h2>
          ...
          <div
            ...
            <div
              className={`${classes.burgerIconLine} ${classes.burgerIconLine1}`}></div>
            <div
              className={`${classes.burgerIconLine} ${classes.burgerIconLine2}`}></div>
            <div
              className={`${classes.burgerIconLine} ${classes.burgerIconLine3}`}></div>
          </div>
        </div>
        <Menu
      ...
      <MobileNav
        showMobileNav={navOpen}
        mobileNavHandler={() => showMobileNav()}
      />
    </>
  )
}
